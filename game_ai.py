...
class SnakeGameAI:
    ...
    def __init__(self, w=1320, h=720):
        ...
        self.reset()
        # Enemies
        self.enemy = Enemy(640, 285, 14, 14, True, (0, 0, 255))
        self.enemy2 = Enemy(640, 415, 14, 14, True, (0, 0, 255))
        self.enemy3 = Enemy(640, 350, 14, 14, True, (0, 0, 255), False)
        self.enemy4 = Enemy(640, 480, 14, 14, True, (0, 0, 255), False)
        # Colliders
