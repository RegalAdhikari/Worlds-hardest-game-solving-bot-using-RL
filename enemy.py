...
class Enemy:
    def __init__(self, player_x, player_y, width, height, enemy_speed=5, color=(0, 0, 255), direction=1, up=True, right=True, left=True, down=True):
    ...
    def draw(self, screen):
        pygame.draw.circle(screen, self.color, (self.player_x, self.player_y), self.width)
    ...
    def move3(self, bound_x1, bound_x2, bound_y1, bound_y2):
        ...
        self.rect2.topleft = (self.player_x, self.player_y)
